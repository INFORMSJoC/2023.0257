library(readxl)
Piston_example_mean <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Piston_example_mean.xlsx",col_names = FALSE)
#Piston_example_std <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Piston_example_std.xlsx",col_names = FALSE)
