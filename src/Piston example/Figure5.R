library(readxl)
Piston_example_mean <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Piston_example_mean.xlsx",col_names = FALSE) #mean
#Piston_example_std <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Piston_example_std.xlsx",col_names = FALSE)  #standard deviation
...
for (ni in 1:nn) {
  ...
  if (ni==1) {
    #mean    
    matplot(wei,type="l",xlab=expression(n),ylab="Relative Targeted Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.95,1.15),xaxt='n',col=col1,mgp=c(2.2,1,0))
    ...
    #srandard deviation
#    matplot(wei,type="l",xlab=expression(n),ylab="Relative Standard Deviation of Targeted Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.8,2),xaxt='n',col=col1,mgp=c(2.2,1,0))
#    matpoints(wei,type="p",pch=c(0,1,9:14,2,3,4,5,6),main=main1,xlab=expression(c),ylab="Relative Targeted Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.8,2),xaxt='n',col=col1,mgp=c(2.2,1,0))
      }else{
    #mean        
    matplot(wei,type="l",xlab=expression(n),ylab="Relative Surrogate Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.96,1.2),xaxt='n',col=col1,mgp=c(2.2,1,0))
    ...
    #srandard deviation
#    matplot(wei,type="l",xlab=expression(n),ylab="Relative Standard Deviation of Surrogate Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.8,3),xaxt='n',col=col1,mgp=c(2.2,1,0))
#    matpoints(wei,type="p",pch=c(0,1,9:14,2,3,4,5,6),main=main1,xlab=expression(c),ylab="Relative Surrogate Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=c(0.7,3),xaxt='n',col=col1,mgp=c(2.2,1,0))
      }
