library(readxl)
Sim1_PL <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Sim1_PL.xlsx",col_names = FALSE)
View(Sim1_PL)
...
#awei[1,,]=as.matrix(Sim1_PL[1:11,c(1:7)],11,7) 
#awei[2,,]=as.matrix(Sim1_PL[25:35,c(1:7)],11,7) 
#awei[3,,]=as.matrix(Sim1_PL[49:59,c(1:7)],11,7) 
#awei[4,,]=as.matrix(Sim1_PL[73:83,c(1:7)],11,7)  

#Targeted PL

awei[1,,]=as.matrix(Sim1_PL[12:22,c(1:7)],11,7) 
awei[2,,]=as.matrix(Sim1_PL[36:46,c(1:7)],11,7) 
awei[3,,]=as.matrix(Sim1_PL[60:70,c(1:7)],11,7) 
awei[4,,]=as.matrix(Sim1_PL[84:94,c(1:7)],11,7)  
