library(readxl)
Sim1_w <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Sim1_w.xlsx",col_names = FALSE)
View(Sim1_w)
...
#weight
awei[1,,]=as.matrix(Sim1_w[1:11,c(1:5)],11,5) 
awei[2,,]=as.matrix(Sim1_w[14:24,c(1:5)],11,5) 
awei[3,,]=as.matrix(Sim1_w[27:37,c(1:5)],11,5) 
awei[4,,]=as.matrix(Sim1_w[40:50,c(1:5)],11,5) 
