...
if jj==4; n=500; Ks=floor([2,n]);  end %[2,5,10,n/8,n/6,n/5,n/4,n/3,n/2,n]
if jj==5; n=1000; Ks=floor([2,n]);  end%[2,5,10,n/8,n/6,n/5,n/4,n/3,n/2,n]
...
if jj==2; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Table7.xlsx',time,'A1'); 
end
if jj==3; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Table7.xlsx',time,'B1'); 
end
if jj==4; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Table7.xlsx',time,1,'C1');
end
if jj==5; 
	xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Table7.xlsx',time,1,'D1');
end
