library(readxl)
SimA5_w <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/SimA5_w.xlsx",col_names = FALSE)
...
awei[1,,]=as.matrix(SimA5_w[1:11,c(1:5)],11,5) 
awei[2,,]=as.matrix(SimA5_w[14:24,c(1:5)],11,5) 
awei[3,,]=as.matrix(SimA5_w[27:37,c(1:5)],11,5) 
awei[4,,]=as.matrix(SimA5_w[40:50,c(1:5)],11,5) 
