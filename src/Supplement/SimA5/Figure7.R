...
for (ni in 1:nn) {
  ...
  par(mar=c(5, 5, 2, 1))
  #Surrogate PL
#  matplot(c,wei,type="l",main=main1,xlab=expression(c),ylab="Relative Surrogate Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=ylim1,xaxt='n',col=col1,mgp=c(2.2,1,0))
#  matpoints(c,wei,type="p",pch=0:2,main=main1,xlab=expression(c),ylab="Relative Surrogate Empirical Ranking Risk",lty=ltype1,lwd=lthick1,ylim=ylim1,xaxt='n',col=col1,mgp=c(2.2,1,0))
  #Targeted PL
