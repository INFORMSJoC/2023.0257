...
for k=1:kn                                                                
    ...
    if k~=kn
        K=Ks(k);                                                         
        [w_k,v_k,wplma,vplma,losspl]=plma_kcv_mix_approximate_lambda_CV_all_Annals(x,y,n,K,M,t0,w0,myfun,options);
...
% % % % %         ppl_Annals_4_pl_in(k)=pairwise_loss_approximate_Annals_4(length(y),y,yin,wplma');  
    ...
    elseif k==kn 
        K=Ks(k);
        [w_k,v_k]=kcv_mix(x,y,n,K,M,t0,w0,myfun,options);
        w_ks(k,:)=w_k;  
        v_ks(k)=v_k;
        y_ks(k,:)=yy*w_k;
        y_ks_in(k,:)=yin*w_k;
...
if jj==1; 
    ...
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_W50.xlsx',1-w_cn_pl_loss(:,[1,2,3,7,9])); 
    
end
if jj==2;
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_Pl.xlsx',[ppl_Annals_2_cn(:,[1:2,6,17:19,25])./ppl_Annals_2_cn(:,18);ppl_cn(:,[1:2,6,17:19,25])./ppl_cn(:,18)],1,'A1'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_W.xlsx',1-w_cn_pl_loss(:,[1,2:4,9]),1,'A1'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_comprae.xlsx',[ppl_Annals_2_cn(:,[1:2,6])./ppl_Annals_2_cn(:,6);ppl_cn(:,[1:2,6])./ppl_cn(:,6)],1,'A1'); 
end         
if jj==3; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_Pl.xlsx',[ppl_Annals_2_cn(:,[1:2,6,17:19,25])./ppl_Annals_2_cn(:,18);ppl_cn(:,[1:2,6,17:19,25])./ppl_cn(:,18)],1,'A25'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_W.xlsx',1-w_cn_pl_loss(:,[1,2:4,9]),1,'A14'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_comprae.xlsx',[ppl_Annals_2_cn(:,[1:2,6])./ppl_Annals_2_cn(:,6);ppl_cn(:,[1:2,6])./ppl_cn(:,6)],1,'A25');     
end   
if jj==4; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_Pl.xlsx',[ppl_Annals_2_cn(:,[1:2,6,17:19,25])./ppl_Annals_2_cn(:,18);ppl_cn(:,[1:2,6,17:19,25])./ppl_cn(:,18)],1,'A49'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_W.xlsx',1-w_cn_pl_loss(:,[1,2:4,9]),1,'A27'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_comprae.xlsx',[ppl_Annals_2_cn(:,[1:2,6])./ppl_Annals_2_cn(:,6);ppl_cn(:,[1:2,6])./ppl_cn(:,6)],1,'A49');     
end     
if jj==5; 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_Pl.xlsx',[ppl_Annals_2_cn(:,[1:2,6,17:19,25])./ppl_Annals_2_cn(:,18);ppl_cn(:,[1:2,6,17:19,25])./ppl_cn(:,18)],1,'A73'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_W.xlsx',1-w_cn_pl_loss(:,[1,2:4,9]),1,'A40'); 
    xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA5_comprae.xlsx',[ppl_Annals_2_cn(:,[1:2,6])./ppl_Annals_2_cn(:,6);ppl_cn(:,[1:2,6])./ppl_cn(:,6)],1,'A73');         
end 
