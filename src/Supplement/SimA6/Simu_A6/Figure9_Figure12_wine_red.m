...
% parameters
S=50;                         
n2s=7;                         % evaluation set  13; 8; 5
n1=20;                         % training set    20; 25; 28
...
for k=1:kn
    if k~=kn
        K=Ks(k);
%         [w_k,v_k,wplma,vplma,losspl]=plma_kcv_linearM_approximate_lambda_CV_all(x,y,n1,K,M,Pi,w0,options);
...
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA6_Wine_exapmle_mean.xlsx',ppl_cn(:,[1:8,10,15:17])./ppl_cn(:,16),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA6_Wine_exapmle_mean.xlsx',ppl_Annals_2_cn(:,[1:8,10,15:17])./ppl_Annals_2_cn(:,16),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA6_Wine_exapmle_std.xlsx',ppl_cn_sd(:,[1:8,10,15:17])./ppl_cn_sd(:,16),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\SimA6_Wine_exapmle_std.xlsx',ppl_Annals_2_cn_sd(:,[1:8,10,15:17])./ppl_Annals_2_cn_sd(:,16),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_mean.xlsx',ppl_cn(:,10),1,'B1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_mean.xlsx',ppl_Annals_2_cn(:,10),1,'B3');
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_std.xlsx',ppl_cn_sd(:,10),1,'B1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_std.xlsx',ppl_Annals_2_cn_sd(:,10),1,'B3');
