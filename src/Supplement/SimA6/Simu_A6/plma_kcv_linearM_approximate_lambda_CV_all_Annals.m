function [w_kcv,v_kcv,wplma,vplma,losspl] = plma_kcv_linearM_approximate_lambda_CV_all_Annals(x,y,n,K,M,Pi,w0,options)
...
plfun=@(w)CV_plM_sim2_linear_Annals(x,y,K,idx,n0,n_K,M,Pi,w);
Aeq=ones(1,M);
beq=1;
lb=zeros(1,M);
ub=ones(1,M);
...
% losspl=CV_plM_sim2_linear_Annals(x,y,K,idx,n0,n_K,M,Pi,w_pl');

losspl=CV_plM_sim2_linear_real(x,y,K,idx,n0,n_K,M,Pi,w_pl');
