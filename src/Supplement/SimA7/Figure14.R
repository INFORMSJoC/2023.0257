library(readxl)
Survival_example_mean <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Survival_example10_mean.xlsx",col_names = FALSE)
#Survival_example_std <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Survival_example10_std.xlsx",col_names = FALSE)
