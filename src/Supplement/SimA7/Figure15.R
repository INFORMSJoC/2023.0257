library(readxl)
Survival_example_mean <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Survival_example20_mean.xlsx",col_names = FALSE)
#Survival_example_std <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Survival_example20_std.xlsx",col_names = FALSE)
