...
n2s=172;                      
n1=100;                                
if n1==100; Ks=floor([2,5,10,n1/2,n1]);  end
kn=length(Ks);
cons=ones(n1,1);
...
RscriptFileName = 'C:\Users\dell\Desktop\2023.0257\scr\Supplement\SimA7\SimuA7_20'; 
RunRcode(RscriptFileName, Rpath); 

order_ini=load('screen.mat');

order=order_ini.r_ans(1:20*M-1);
...
for m=1:M
    ...
    yy(m,:)=x0(:,20*(m-1)+1:20*m)*betam;
    yin(m,:)=x(:,20*(m-1)+1:20*m)*betam;
...
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_mean.xlsx',ppl_cn(:,[1:8,10,16:19])./ppl_cn(:,17),1,'A2'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_mean.xlsx',ppl_Annals_2_cn(:,[1:8,10,16:19])./ppl_Annals_2_cn(:,17),1,'A5'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_std.xlsx',ppl_cn_sd(:,[1:8,10,16:19])./ppl_cn_sd(:,17),1,'A2'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_std.xlsx',ppl_Annals_2_cn_sd(:,[1:8,10,16:19])./ppl_Annals_2_cn_sd(:,17),1,'A5'); 
