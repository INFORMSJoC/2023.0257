...
n2s=72;                      
n1=200;                                
if n1==200; Ks=floor([2,5,10,n1/2,n1]);  end
kn=length(Ks);
cons=ones(n1,1);
...
save 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_mean.xlsx',ppl_cn(:,[1:8,10,16:19])./ppl_cn(:,17),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_mean.xlsx',ppl_Annals_2_cn(:,[1:8,10,16:19])./ppl_Annals_2_cn(:,17),1,'A6'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_std.xlsx',ppl_cn_sd(:,[1:8,10,16:19])./ppl_cn_sd(:,17),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Survival_exmple20_std.xlsx',ppl_Annals_2_cn_sd(:,[1:8,10,16:19])./ppl_Annals_2_cn_sd(:,17),1,'A6'); 
