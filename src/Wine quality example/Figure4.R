library(readxl)
Wine_example_mean <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Wine_example_mean.xlsx",col_names = FALSE) # mean
#Wine_example_std <- read_excel("C:/Users/dell/Desktop/2023.0257/scr/output/Wine_example_std.xlsx",col_names = FALSE)  # srandard deviation
