...
data=xlsread('group score');
Y=data(2:28,2);             
X=zscore(data(2:28,3:21));
N=length(Y);
p=size(X,2);
...
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_mean.xlsx',ppl_cn(:,[1:8,10,15:17])./ppl_cn(:,16),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_mean.xlsx',ppl_Annals_2_cn(:,[1:8,10,15:17])./ppl_Annals_2_cn(:,16),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_std.xlsx',ppl_cn_sd(:,[1:8,10,15:17])./ppl_cn_sd(:,16),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_std.xlsx',ppl_Annals_2_cn_sd(:,[1:8,10,15:17])./ppl_Annals_2_cn_sd(:,16),1,'A3'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_mean.xlsx',ppl_cn(:,10),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_mean.xlsx',ppl_Annals_2_cn(:,10),1,'A3');
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_std.xlsx',ppl_cn_sd(:,10),1,'A1'); 
xlswrite('C:\Users\dell\Desktop\2023.0257\scr\output\Wine_exapmle_com_std.xlsx',ppl_Annals_2_cn_sd(:,10),1,'A3');
